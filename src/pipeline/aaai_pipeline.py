...
if __name__ == '__main__':
    ...
    p_steps = {
        's1.tokenizing': {
            'do': False,
            'out_file': config.RESULT_PATH / "pipeline_r_aaai_doc/2018_09_02_17:11:42_r/t_shared_task_dev.jsonl"
        },
        's2.1doc_retri': {
            'do': False,
            'out_file': config.RESULT_PATH / "pipeline_r_aaai_doc/2018_09_02_17:11:42_r/doc_retr_1_shared_task_dev.jsonl"
        },
        ...
        's3.1sen_select': {
            'do': False,
            # 'out_file': config.RESULT_PATH / "pipeline_r_aaai_doc/2018_09_02_17:11:42_r/dev_sent_score_1_shared_task_dev_ensembled.jsonl",
            'out_file': config.RESULT_PATH / "pipeline_r_aaai_doc/2018_09_02_17:11:42_r/dev_sent_score_1_shared_task_dev.jsonl",
            # (0.9117911791179117, 1.0, 0.2873662366236248, 0.8676867686768677, 0.43174448296061907)
            # 'out_file': config.RESULT_PATH / "pipeline_r_aaai_doc/2018_09_02_17:11:42_r/dev_sent_score_1_shared_task_dev_e1.jsonl", # (0.9116411641164116, 1.0, 0.2969621962195836, 0.8674617461746175, 0.44245628400739456)
            # 'out_file': config.RESULT_PATH / "pipeline_r_aaai_doc/2018_09_02_17:11:42_r/dev_sent_score_1_shared_task_dev_e2.jsonl", # (0.9117911791179117, 1.0, 0.30215271527148735, 0.8676867686768677, 0.4482220283350134)
            'ensemble': True,
        },
    ...
    p_steps_doc_10 = {
        's1.tokenizing': {
            'do': False,
            'out_file': config.RESULT_PATH / "pipeline_r_aaai_doc/2018_09_03_10:53:54_r/t_shared_task_dev.jsonl"
        },
        's2.1doc_retri': {
            'do': False,
            'out_file': config.RESULT_PATH / "pipeline_r_aaai_doc/2018_09_03_10:53:54_r/doc_retr_1_shared_task_dev.jsonl"
        },

        's2.2.1doc_nn_retri': {
            'do': False,
            'out_file': config.RESULT_PATH / "pipeline_r_aaai_doc/2018_09_03_10:53:54_r/nn_doc_list_1_shared_task_dev.jsonl"
        },

        's3.1sen_select': {
            'do': False,
            # 'out_file': config.RESULT_PATH / "pipeline_r_aaai_doc/2018_09_02_17:11:42_r/dev_sent_score_1_shared_task_dev_ensembled.jsonl",
            'out_file': config.RESULT_PATH / "pipeline_r_aaai_doc/2018_09_03_10:53:54_r/dev_sent_score_1_shared_task_dev_docnum(10).jsonl",
            # (0.9117911791179117, 1.0, 0.2873662366236248, 0.8676867686768677, 0.43174448296061907)
            # 'out_file': config.RESULT_PATH / "pipeline_r_aaai_doc/2018_09_02_17:11:42_r/dev_sent_score_1_shared_task_dev_e1.jsonl", # (0.9116411641164116, 1.0, 0.2969621962195836, 0.8674617461746175, 0.44245628400739456)
            # 'out_file': config.RESULT_PATH / "pipeline_r_aaai_doc/2018_09_02_17:11:42_r/dev_sent_score_1_shared_task_dev_e2.jsonl", # (0.9117911791179117, 1.0, 0.30215271527148735, 0.8676867686768677, 0.4482220283350134)
            'ensemble': True,
        ...
        's4.2doc_retri': {
            'do': False,
            'out_file': config.RESULT_PATH / "pipeline_r_aaai_doc/2018_09_03_10:53:54_r/doc_retr_2_shared_task_dev.jsonl"
        },
        's5.2sen_select': {
            'do': False,
            'out_file': config.RESULT_PATH / "pipeline_r_aaai_doc/2018_09_03_10:53:54_r/dev_sent_score_2_shared_task_dev.jsonl"
        },
        's6.nli': {
            'do': False,
            # 'out_file': config.RESULT_PATH / "pipeline_r_aaai_doc/2018_09_02_17:11:42_r/nli_r_shared_task_dev.jsonl"
            # 'out_file': config.RESULT_PATH / "pipeline_r_aaai_doc/2018_09_02_17:11:42_r/nli_r_shared_task_dev_scale:0.5.jsonl"
            'out_file': config.RESULT_PATH / "pipeline_r_aaai_doc/2018_09_03_10:53:54_r/nli_r_shared_task_dev_no_doc_scale:0.05.jsonl"
        }
    }
    ...
    p_step_test = {
        's1.tokenizing': {
            'do': False,
            'out_file': config.RESULT_PATH / 'pipeline_r_aaai_doc/2018_09_03_23:59:27_r/t_shared_task_test.jsonl'
        # if false, we will directly use the out_file, This out file for downstream
        },
        's2.1doc_retri': {
            'do': False,
            'out_file': config.RESULT_PATH / 'pipeline_r_aaai_doc/2018_09_03_23:59:27_r/nn_doc_retr_1_shared_task_test.jsonl'
        # if false, we will directly use the out_file, for downstream
        },

        's2.2.1doc_nn_retri': {
            'do': False,
            'out_file': config.RESULT_PATH / "pipeline_r_aaai_doc/2018_09_03_23:59:27_r/nn_doc_list_1_shared_task_test.jsonl"
        },

        's3.1sen_select': {
            'do': False,
            'out_file': config.RESULT_PATH / "pipeline_r_aaai_doc/2018_09_03_23:59:27_r/dev_sent_score_1_shared_task_test_docnum(10)_ensembled.jsonl",
            'ensemble': True,
        },

        's4.2doc_retri': {
            'do': False,
            'out_file': config.RESULT_PATH / "pipeline_r_aaai_doc/2018_09_03_23:59:27_r/doc_retr_2_shared_task_test.jsonl"
        },
        's5.2sen_select': {
            'do': False,
            'out_file': config.RESULT_PATH / "pipeline_r_aaai_doc/2018_09_03_23:59:27_r/dev_sent_score_2_shared_task_test.jsonl"
        },
        's6.nli': {
            'do': False,
            # 'out_file': config.RESULT_PATH / "pipeline_r_aaai_doc/2018_09_02_17:11:42_r/nli_r_shared_task_dev.jsonl"
    ...
    #     's1.tokenizing': {
    #         'do': False,
    #         'out_file': config.RESULT_PATH / 'pipeline_r_aaai_doc/2018_09_05_12:17:06_r/t_shared_task_dev.jsonl'
    #         # if false, we will directly use the out_file, This out file for downstream
    #     },
    #     's2.1doc_retri': {
    #         'do': False,
    #         'out_file': config.RESULT_PATH / 'pipeline_r_aaai_doc/2018_09_05_12:17:06_r/nn_doc_retr_1_shared_task_dev.jsonl'
    #         # if false, we will directly use the out_file, for downstream
    #     },
    #
    #     's2.2.1doc_nn_retri': {
    #         'do': False,
    #         'out_file': config.RESULT_PATH / "pipeline_r_aaai_doc/2018_09_05_12:17:06_r/nn_doc_list_1_shared_task_dev.jsonl"
    #     },
    #
    #     's3.1sen_select': {
    #         'do': False,
    #         # 'out_file': config.RESULT_PATH / "pipeline_r_aaai_doc/2018_09_05_12:17:06_r/dev_sent_score_1_shared_task_dev_docnum(10)_ensembled.jsonl",
    #         'out_file': config.RESULT_PATH / "pipeline_r_aaai_doc/2018_09_05_12:17:06_r/dev_sent_score_1_shared_task_dev_docnum(10).jsonl",
    #         'ensemble': True,
    #     },
    #
    #     's4.2doc_retri': {
    #         'do': False,
    #         'out_file': config.RESULT_PATH / "pipeline_r_aaai_doc/2018_09_05_12:17:06_r/doc_retr_2_shared_task_dev.jsonl"
    #     },
    #     's5.2sen_select': {
    #         'do': False,
    #         'out_file': config.RESULT_PATH / "pipeline_r_aaai_doc/2018_09_05_12:17:06_r/dev_sent_score_2_shared_task_dev.jsonl"
    #     },
    #     's6.nli': {
    #         'do': True,
    #         'out_file': config.RESULT_PATH / "pipeline_r_aaai_doc/2018_09_05_12:17:06_r/single_sent_nli_r_shared_task_dev_no_doc_scale:0.05_e0.jsonl"
    #         # 'out_file': config.RESULT_PATH / "pipeline_r_aaai_doc/2018_09_05_12:17:06_r/nli_r_shared_task_dev_with_doc_scale:0.05_e0.jsonl"
    #         # 'out_file': config.RESULT_PATH / "pipeline_r_aaai_doc/2018_09_05_12:17:06_r/nli_r_shared_task_dev_no_doc_scale:0.05_e0.jsonl"
    #         # 'out_file': config.RESULT_PATH / "pipeline_r_aaai_doc/2018_09_02_17:11:42_r/nli_r_shared_task_dev.jsonl"
    #         # 'out_file': config.RESULT_PATH / "pipeline_r_aaai_doc/2018_09_02_17:11:42_r/nli_r_shared_task_dev_scale:0.5.jsonl"
    #         # 'out_file': config.RESULT_PATH / "pipeline_r_aaai_doc/2018_09_02_17:11:42_r/nli_r_shared_task_dev_no_doc_scale:0.05.jsonl"
    #     }
    ...
    #     's6.nli': {
    #         'do': False,
    #         'out_file': config.RESULT_PATH / "pipeline_r_aaai_doc/2018_09_05_12:17:06_r/single_sent_nli_r_shared_task_dev_no_doc_scale:0.1_e0.jsonl"
    #         # 'out_file': config.RESULT_PATH / "pipeline_r_aaai_doc/2018_09_05_12:17:06_r/nli_r_shared_task_dev_with_doc_scale:0.05_e0.jsonl"
    #         # 'out_file': config.RESULT_PATH / "pipeline_r_aaai_doc/2018_09_05_12:17:06_r/nli_r_shared_task_dev_no_doc_scale:0.05_e0.jsonl"
    #         # 'out_file': config.RESULT_PATH / "pipeline_r_aaai_doc/2018_09_02_17:11:42_r/nli_r_shared_task_dev.jsonl"
    #         # 'out_file': config.RESULT_PATH / "pipeline_r_aaai_doc/2018_09_02_17:11:42_r/nli_r_shared_task_dev_scale:0.5.jsonl"

...
def train_fever_std_ema_v1(resume_model=None, do_analysis=False):
    ...
    schedule_sample_dict = defaultdict(lambda: 0.06)
    ...
    experiment_name = f"vc_ss_v16_ratio_ss_for_vc:{ratio_ss_for_vc}|t_prob:{train_prob_threshold}|top_k:{train_sample_top_k}_scheduled_neg_sampler"
    # resume_model = None

...
from simi_sampler_nli_v0.simi_sampler import paired_selection_score_dict, threshold_sampler, \
    select_sent_with_prob_for_eval, adv_simi_sample_with_prob_v1_0
...
def train_fever_v1_advsample():
    ...
    experiment_name = f"mesim_wn_simi_v11_|t_prob:{train_prob_threshold}|top_k:{train_sample_top_k}"
